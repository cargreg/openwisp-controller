...
django.jQuery(function ($) {
    ...
    function typeChange(e, initial) {
        var value = $type.val();
        if (value) {
            $('.map_canvas_wrapper').attr('style', function(i, style)
            {
    ...
    function locationChange(e, initial) {
        ...
        if (!initial) {
            ...
            $.getJSON(url, function (data) {
                ...
                $("#id_geolocation").val(data.geolocation);
                $geolocation.show();
                console.log("<<<<<<<<< address value: "+ $("#id_address").val());
                $('.map_canvas_wrapper').attr('style', function(i, style)
                {
                     return style && style.replace(/display[^;]+;?/g, '');
                });
                var latlon;
                latlon=$("#id_geolocation").val();
